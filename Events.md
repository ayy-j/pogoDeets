...
All events include extra **generic** data (added in [#18](https://github.com/bigfoott/ScrapedDuck/pull/18)):
...
For some event types, it would be useful to have more information than what's provided in the title and heading of an event.
